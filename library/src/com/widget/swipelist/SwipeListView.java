...
public class SwipeListView extends ListView {
	...
	public SwipeListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int widthWindow = (int)((wm.getDefaultDisplay().getWidth())*0.3);
        
		// 获取自定义属性和默认值

		// if(HomePageBottomTab.screenHeight>=1000||HomePageBottomTab.screenWidth>=1000){
		// // 获取自定义属性和默认值

		mRightViewWidth = (int) mTypedArray.getDimension(

		R.styleable.swipelistviewstyle_right_width, widthWindow);
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_UP:
			...
			// if (lastY > mFirstY || lastY < mFirstY) {
			// return false;
			// }
			// return false;
